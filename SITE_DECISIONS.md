...
- **Список услуг (монет):**
  ...
  7–10. **[ЖДЁТ ПОДТВЕРЖДЕНИЯ]** кандидаты: Telegram-ассистент, AI-видео/Reels-завод,
     Бродкаст-автоматизация (AIRSAT), AI-музыка (ACE-Step). + уточнить, что Pavel назвал «Proki».
