...
- **Вращение — кватернионный трекбол (НЕ Euler!).** Drag вращает вокруг МИРОВЫХ осей через `premultiply` (`WORLD_X`/`WORLD_Y`) → честное кувыркание во все стороны, без gimbal-lock и «блина по часовой». Euler-углы давали плоский поворот — НЕ возвращать к ним.
